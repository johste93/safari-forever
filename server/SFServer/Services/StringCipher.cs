...
namespace Chumpware.Security
{
    public static class StringCipher
    {
        ...
        public static string Encrypt(string plainText, string passPhrase, int blockSize = 256)
        {
            // Salt and IV is randomly generated each time, but is preprended to encrypted cipher text
            // so that the same Salt and IV values can be used when decrypting.  
            var saltStringBytes = GenerateNBitsOfRandomEntropy(blockSize);
            var ivStringBytes = GenerateNBitsOfRandomEntropy(blockSize);
        ...
        public static string Decrypt(string cipherText, string passPhrase, int blockSize = 256)
        {
        ...
        private static byte[] GenerateNBitsOfRandomEntropy(int blockSize)
        {
