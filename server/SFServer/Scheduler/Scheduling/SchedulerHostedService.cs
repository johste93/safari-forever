...
namespace SFServer.Scheduler.Scheduling
{
    public class SchedulerHostedService : HostedService
    {
        ...
        public SchedulerHostedService(IEnumerable<IScheduledTask> scheduledTasks, IServiceScopeFactory serviceScopeFactory, IWebHostEnvironment webHostEnvironment)
        {
            ...
            {
                //Assume Linux
                timeZoneInfo = TimeZoneInfo.FindSystemTimeZoneById("Europe/Oslo");
            }

            timeZoneInfo = TimeZoneInfo.Local;

            var referenceTime = TimeZoneInfo.ConvertTime(DateTime.UtcNow, timeZoneInfo);
            ...
            foreach (var scheduledTask in scheduledTasks)
            {
                ...
                task.NextRunTime = task.Schedule.GetNextOccurrence(referenceTime.AddMilliseconds(-1));
