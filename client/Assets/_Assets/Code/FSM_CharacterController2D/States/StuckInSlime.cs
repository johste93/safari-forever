...
{
    public class StuckInSlime : IState
    {   
        ...
        {      
            ...
            Vector2 wedge = Vector2.down * 0.35f;
        ...
        {
            return Transition_StuckInSlimeToJumping.ConditionsMet(characterController);
        }
