...
public class RailLink : MonoBehaviour
{
    public LineRenderer lineRenderer;
        ...
        [HideInInspector] public RailNode heldNode;
        
        public RailNode_Output nodeA;
        public RailNode_Input nodeB;
        ...
        public void Attach(RailNode_Input targetNode)
        {
        ...
        public RailNode OtherNode(RailNode sourceNode)
        {
            if(sourceNode == nodeA)
                return nodeB;
        ...
        protected void OnEnable()
        {
            ...
            RailCanvas.On_RailCanvasUpdate += On_LogicCanvasUpdate;
        }
